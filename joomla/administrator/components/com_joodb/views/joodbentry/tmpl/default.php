...
if ($this->config->get('internal_editor', 1) == 0) {
	...
	require_once(JPATH_ROOT . '/media/joodb/editor.php');
...
JHtml::_('stylesheet', 'joodb/panes.css', array('version' => 'auto', 'relative' => true));
            ...
            <fieldset class="adminform">
                ...
                <table class="paramlist admintable">
                    ...
                    <tr>
                        ...
                        <td class="paramlist_value">
                            <select name="table" class="required" onchange="submitbutton('apply');"
                    ...
                    <tr>
                        ...
                        <td class="paramlist_value">
                            ...
                            echo '<select name="fid"  class=""  style="width: 250px" >';
                    ...
                    <tr>
                        ...
                        <td class="paramlist_value">
                            <select name="ftitle" class="" style="width: 250px"><?php
                    ...
                    <tr>
                        ...
                        <td class="paramlist_value">
                            <select name="fcontent" class="" style="width: 250px"><?php
                                foreach ($fselect as $fname) {
                    ...
                    <tr>
                        ...
                        <td class="paramlist_value">
                            <select name="fabstract" class="" style="width: 250px">
                    ...
                    <tr>
                        <td width="250" class="paramlist_key"><?php echo JText::_("ALIAS_FIELD"); ?>:</td>
                        <td class="paramlist_value">
                            <select name="falias" class="" style="width: 250px">
                                <option value="">...</option><?php
				                foreach ($fselect as $fname) {
                    ...
                    <tr>
                        ...
                        <td class="paramlist_value">
                            <select name="fdate" class="" style="width: 250px">
                                <option value="">...</option><?php
                    ...
                    <tr>
                        ...
                        <td class="paramlist_value">
                            <select name="fstate" class="" style="width: 250px">
                                <option value="">...</option><?php
                    ...
                    <tr>
                        ...
                        <td class="paramlist_value">
                            <select name="fuser" class="" style="width: 250px">
                                <option value="">...</option><?php
                                $fselect = JoodbAdminHelper::selectFieldTypes("number", $fields);
                                foreach ($fselect as $fname) {
